package com.redravencomputing.calculator
...
private const val OPERATION_STATE = "OperationState"
private const val OPERAND1_STATE = "Operand1"
private const val STATE_OPERAND1_STORE = "Operand1Store"
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onRestoreInstanceState(savedInstanceState: Bundle) {
        ...
        operand1 = if (savedInstanceState.getBoolean(STATE_OPERAND1_STORE, false)) {
            savedInstanceState.getDouble(OPERAND1_STATE)
        } else {
            null
        }
